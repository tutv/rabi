...
import {ChannelBuilderOption} from '../core/createRabbitMQConnection'

const DEFAULT_CHANNEL_PREFETCH = 500
const DEFAULT_CONSUMER_PREFETCH = 500


export class ChannelBuilder {
    static ConnectionRegistries: Map<ConnectionBuilder, ChannelBuilder> = new Map()

    public static getChannelBuilder(connection: ConnectionBuilder, opts?: ChannelBuilderOption): ChannelBuilder {
    ...
    private constructor(connection: ConnectionBuilder, opts?: ChannelBuilderOption) {
        ...
        }, this.connection.channelOpts, opts)
    }
